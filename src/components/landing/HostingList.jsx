...
const HostingList = () => {
    const [hostings, setHostings] = useState([
        ...
        {
            "name": "LynxNodes S.L",
            "description": "LynxNodes es un servicio de hosting gratuito que ofrece una solución completa para alojar servidores y aplicaciones en diversos lenguajes de programación y plataformas. Entre los servicios que proporciona, se encuentran opciones para servidores de Node.js, Python y Lua, permitiendo a los desarrolladores desplegar sus proyectos de forma sencilla y eficiente.",
    ...
    return (
        <section id="hosting" className="container mx-auto py-8">
            <h1 className="text-3xl font-bold text-center mb-8">Hostings Destacados</h1>
            {hostings.length === 0 ? (
